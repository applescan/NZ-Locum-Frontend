...
export default function DoctorProfile() {
    ...
    const handleChanges = async (event) => {
        ...
        try {
            await axios.delete(`http://nzlocumnetwork-env.eba-beqbmmm3.us-east-1.elasticbeanstalk.com/doctors/delete/${user._id}`);
    ...
    useEffect(() => {
        ...
        if (user) {
            ...
            const getUserById = async () => {
                const res = await axios.get(`http://nzlocumnetwork-env.eba-beqbmmm3.us-east-1.elasticbeanstalk.com/doctors/search/${user._id}`);
    ...
    const handleSubmit = (event) => {
        ...
        try {
            fetch(`http://nzlocumnetwork-env.eba-beqbmmm3.us-east-1.elasticbeanstalk.com/doctors/update/${user._id}`, {
                method: "POST",
                body: toSend
            }).then(() => {
                window.location.reload()
                        ...
                        <MDBCol lg="4">
                            <MDBCard className="mb-4">
                                <MDBCardBody className="text-center">
                                    <MDBCardImage
                                        src={`http://nzlocumnetwork-env.eba-beqbmmm3.us-east-1.elasticbeanstalk.com/images/${currentUserInfo.imageKey}`}
                                        alt="avatar"
                                        className="rounded"
