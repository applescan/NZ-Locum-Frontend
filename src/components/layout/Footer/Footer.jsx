        ...
        <div className="footer__content">
          <div className="footer__logo">
            ...
            <p className="footer__tagline">
              Connecting veterinary professionals across New Zealand
            </p>
          </div>
          ...
          <div className="footer__links">
            <div className="footer__links-group">
              ...
              <ul className="footer__list">
                ...
                <li className="footer__item">
                  <Link to="/job-search" className="footer__link">
                    Job Search
                  </Link>
                </li>
                <li className="footer__item">
                ...
                <li className="footer__item">
                  <Link to="/clinics" className="footer__link">
                    Clinics
                  </Link>
                </li>
                <li className="footer__item">
            ...
            <div className="footer__links-group">
              ...
              <ul className="footer__list">
                ...
                <li className="footer__item">
                  <Link to="/doctor-profile" className="footer__link">
                    Doctor Profile
                  </Link>
                </li>
                <li className="footer__item">
                  <Link to="/clinic-profile" className="footer__link">
                    Clinic Profile
                  </Link>
                </li>
              </ul>
