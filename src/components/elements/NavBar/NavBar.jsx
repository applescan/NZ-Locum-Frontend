      ...
      <div className="nav-shadow">
        ...
        >
          <MDBContainer fluid>
            ...
            >
              <img src={Toggle} height="40" alt="toggle icon" loading="lazy" />
            </MDBNavbarToggler>

            <MDBCollapse navbar show={showNav}>
              <MDBNavbarNav style={{ margin: 20 }}>
                <MDBNavbarItem>
                  <MDBNavbarLink href="/job-search">Job Search</MDBNavbarLink>
                </MDBNavbarItem>
                <MDBNavbarItem>
                  <MDBNavbarLink href="/doctors">Doctors</MDBNavbarLink>
                </MDBNavbarItem>
                <MDBNavbarItem>
