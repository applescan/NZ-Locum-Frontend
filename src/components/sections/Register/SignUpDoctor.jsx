...
export default function SignUp() {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post(
        "https://nz-locum-backend-3a82ed85ab97.herokuapp.com/doctors/add",
        toSend,
        {
          headers: {
    ...
    return (
      <>
        <div id="Doctor-registration">
          <PageHeader
            maoriTitle="Rēhita hei waahi"
            englishTitle="Register as a locum"
            background={DoctorRegistrationBanner}
          />
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12}>
                    <TextField
                      ...
                      rows={2}
                      onChange={(e) =>
                        setDetails({ ...details, specialities: e.target.value })
                      }
                    />
                  </Grid>
                  <Grid item xs={12}>
                  ...
                  <Grid item xs={12}>
                    <TextField
                      ...
                      onChange={(e) =>
                        setDetails({
                          ...details,
                          work_requirement: e.target.value,
                        })
                      }
                    />
