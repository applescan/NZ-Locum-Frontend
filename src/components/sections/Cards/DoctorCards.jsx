...
export default function DoctorList() {
    ...
    useEffect(() => {
        axios
            .get('http://nzlocumnetwork-env.eba-beqbmmm3.us-east-1.elasticbeanstalk.com/doctors/all')
            .then(res => {
                console.log(res)
                setPost(res.data)
            })
    ...
    useEffect(() => {
        axios
            .get('http://nzlocumnetwork-env.eba-beqbmmm3.us-east-1.elasticbeanstalk.com/doctors/search/city/north')
            .then(res => {
                //console.log(res)
    ...
    useEffect(() => {
        axios
            .get('http://nzlocumnetwork-env.eba-beqbmmm3.us-east-1.elasticbeanstalk.com/doctors/search/city/auck')
            .then(res => {
                //console.log(res)
    ...
    useEffect(() => {
        axios
            .get('http://nzlocumnetwork-env.eba-beqbmmm3.us-east-1.elasticbeanstalk.com/doctors/search/city/well')
            .then(res => {
                //console.log(res)
    ...
    useEffect(() => {
        axios
            .get('http://nzlocumnetwork-env.eba-beqbmmm3.us-east-1.elasticbeanstalk.com/doctors/search/city/dun')
            .then(res => {
                //console.log(res)
                setDunedin(res.data)
            })
    ...
    useEffect(() => {
        axios
            .get('http://nzlocumnetwork-env.eba-beqbmmm3.us-east-1.elasticbeanstalk.com/doctors/search/city/chr')
            .then(res => {
                //console.log(res)
    ...
    useEffect(() => {
        axios
            .get('http://nzlocumnetwork-env.eba-beqbmmm3.us-east-1.elasticbeanstalk.com/doctors/search/city/queen')
            .then(res => {
                //console.log(res)
                        ...
                        {posts.map(post =>
                            <Col>
                                <Card style={{ width: 'auto' }}>
                                    <Card.Img variant="top" src={`http://nzlocumnetwork-env.eba-beqbmmm3.us-east-1.elasticbeanstalk.com/images/${post.imageKey}`} style={{ width: 'auto', height: '300px', objectFit: 'cover' }} />
                                    <div id='cards'>
                    ...
                    {northland.length > 0 ?
                        <Row xs={1} md={3} lg={4} className="g-4" id='cards'>
                            {northland.map(north =>
                                <Col>
                                    <Card style={{ width: 'auto' }}>
                                        <Card.Img variant="top" src={`http://nzlocumnetwork-env.eba-beqbmmm3.us-east-1.elasticbeanstalk.com/images/${north.imageKey}`} style={{ width: 'auto', height: '300px', objectFit: 'cover' }} />
                                        <div id='cards'>
                    ...
                    {auckland.length > 0 ?
                        <Row xs={1} md={3} lg={4} className="g-4" id='cards'>
                            {auckland.map(auck =>
                                <Col>
                                    <Card style={{ width: 'auto' }}>
                                        <Card.Img variant="top" src={`http://nzlocumnetwork-env.eba-beqbmmm3.us-east-1.elasticbeanstalk.com/images/${auck.imageKey}`} style={{ width: 'auto', height: '300px', objectFit: 'cover' }} />
                                        <div id='cards'>
                    ...
                    {wellington.length > 0 ?
                        <Row xs={1} md={3} lg={4} className="g-4" id='cards'>
                            {wellington.map(wlg =>
                                <Col>
                                    <Card style={{ width: 'auto' }}>
                                        <Card.Img variant="top" src={`http://nzlocumnetwork-env.eba-beqbmmm3.us-east-1.elasticbeanstalk.com/images/${wlg.imageKey}`} style={{ width: 'auto', height: '300px', objectFit: 'cover' }} />
                                        <div id='cards'>
                    ...
                    {dunedin.length > 0 ?
                        <Row xs={1} md={3} lg={4} className="g-4" id='cards'>
                            {dunedin.map(dune =>
                                <Col>
                                    <Card style={{ width: 'auto' }}>
                                        <Card.Img variant="top" src={`http://nzlocumnetwork-env.eba-beqbmmm3.us-east-1.elasticbeanstalk.com/images/${dune.imageKey}`} style={{ width: 'auto', height: '300px', objectFit: 'cover' }} />
                                        <div id='cards'>
                    ...
                    {christchurch.length > 0 ?
                        <Row xs={1} md={3} lg={4} className="g-4" id='cards'>
                            {christchurch.map(chch =>
                                <Col>
                                    <Card style={{ width: 'auto' }}>
                                        <Card.Img variant="top" src={`http://nzlocumnetwork-env.eba-beqbmmm3.us-east-1.elasticbeanstalk.com/images/${chch.imageKey}`} style={{ width: 'auto', height: '300px', objectFit: 'cover' }} />
                                        <div id='cards'>
                    ...
                    {queenstown.length > 0 ?
                        <Row xs={1} md={3} lg={4} className="g-4" id='cards'>
                            {queenstown.map(queens =>
                                <Col>
                                    <Card style={{ width: 'auto' }}>
                                        <Card.Img variant="top" src={`http://nzlocumnetwork-env.eba-beqbmmm3.us-east-1.elasticbeanstalk.com/images/${queens.imageKey}`} style={{ width: 'auto', height: '300px', objectFit: 'cover' }} />
                                        <div id='cards'>
